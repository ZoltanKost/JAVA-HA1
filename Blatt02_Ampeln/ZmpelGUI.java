...
/**
 * Stellt eine Zmpel grafisch dar und ermöglicht das Weiterschalten 
 * zur nächsten Ampelphase per Knopfdruck.
 *  
 * @author Axel Schmolitzky, Fredrik Winkler
 * @version 2025
 */
public class ZmpelGUI
{
    ...
    /**
     * Erzeugt eine neue Zmpel und stellt diese anschließend dar.
     */
    public ZmpelGUI()
    {
        _ampel = new Zmpel();
