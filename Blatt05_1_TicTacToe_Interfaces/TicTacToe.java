 ...
 * 
 * Zwei Spieler spielen auf einem Spielfeld der Größe 3x3 = 9 Positionen. 
...
class TicTacToe
{
    ...
    /**
     * Gibt an, ob das Spiel noch läuft, ob das Spiel unentschieden geendet 
     * ist, oder ob einer der beiden Spieler gewonnen hat.
     * 
     * @return -1 (Spiel läuft noch), 0 (unentschieden), 1 (Spieler 1 hat
    ...
    /**
     * Besetzt eine Position auf dem Spielfeld für den aktuellen Spieler. 
     * Anschliessend wird geprüft, ob der aktuelle Spieler gewonnen hat, oder 
    ...
    /**
     * Diese Methode überprüft, ob der aktuelle Spieler 
     * an allen drei übergebenen Positionen p1, p2 und p3 das Spielfeld besetzt hat.
     * 
    ...
    /**
     * Diese Methode überprüft, ob der aktuelle Spieler das Spiel 
     ...
     * der acht möglichen Gewinnsituationen erreicht hat, sonst false.
     */
