...
/**
 * Diese Klasse definiert Turtles, die mit einfachen Operationen 
 * "bewegt" werden können. Die Bewegungen einer Turtle können 
 * auf einer Zeichenfläche sichtbar gemacht werden, die Turtle 
 * hinterlässt quasi eine Spur. Die Turtle selbst ist nicht sichtbar. 
 * <br><br>
 * Warum gerade eine Turtle, also eine Schildkröte? Hauptsächlich 
 * aufgrund der Programmiersprache LOGO, mit der die Idee der 
 * Turtle Graphics bekannt geworden ist. Etwas mehr Hintergrund 
 * ist hier zu finden: 
 ...
 * <br><br>
 * <b>Diese Klasse muss im Quelltext nicht verstanden werden! Es reicht, 
 * sich mit ihrer Schnittstelle vertraut zu machen. </b>
 * 
...
class Turtle
{
    ...
    // Die Farbe der Spur, die diese Turtle hinterlässt
    private Color _farbe;

    // Gibt an, ob diese Turtle eine Spur hinterlässt oder nicht
    ...
    /**
     * Löscht alle Spuren, die diese Turtle bisher hinterlassen hat.
     */
    ...
    /**
     * Bewegt diese Turtle vorwärts in Blickrichtung. 
     * @param schritte Anzahl der Pixel, die diese Turtle zurücklegen soll
     */
    ...
    /**
     * Lässt diese Turtle auf den angegebenen Punkt (x, y) schauen.
    ...
    /**
     * Setzt die Farbe der Spur, die diese Turtle hinterlässt. 
     * Mögliche Farben sind "schwarz", "blau", "cyan", "dunkelgrau", "grau", "gruen", "hellgrau", "magenta", "orange", "pink", "rot", "weiss", "gelb".
    ...
    /**
     * Setzt eine der 13 möglichen Farben für die Spur.
    ...
    /**
     * Abhängig von der Geschwindigkeit dieser Turtle wird hier 
     * eine kurze Zeit verzögert.
     */
