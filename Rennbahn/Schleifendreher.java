...
/**
 * Halbwegs sinnvolle Beispiele für die Schleifenmechanismen von Java.
 * 
...
class Schleifendreher
{
    ...
    public void druckeDreierZiffernRueckwaerts()
    {
        ...
        // und beliebig große Schritte in beide Richtungen gehen.
        for (int i = 9; i >= 0; i -= 3)
        {
     ...
     * Da die Addition kommutativ ist, werden redundante Paare bewusst vermieden.
     */
    public void druckeNeunerSummen()
    {
        // Es können beliebig viele Schleifenzähler verwendet werden,
        // zum Beispiel zwei "gegeneinander laufende" Zähler,
     ...
     * 
     * @param text Enthält den Text, der ausgegeben werden soll.
     */
    ...
    /**
     * Liefert die kleinste Primzahl, welche größer oder gleich x ist.
     * 
     * @param x Eine Zahl, von der aus mit der Suche begonnen werden soll.
     * 
     * @return die nächste gefundene Primzahl.
     */
    ...
    public void verlangePasswort()
    {
        ...
        // C-Hack: Zeichen hier kodiert über "octal escapes", siehe JLS §3.10.6
        // Wenn ihr die Zeichen sehen wollt: Zeichenkette in die Direkteingabe
        // von BlueJ kopieren und Enter drücken.
    ...
    // Die folgenden privaten Hilfsmethoden müssen nicht verstanden werden.

    /**
     * Liest eine Zeile von der Konsole ein und liefert sie zurück.
     * 
     * @return Eine auf der Konsole eingegebene Textzeile.
     */
    ...
    /**
     * Bestimmt, ob es sich bei der übergebenen Zahl um eine Primzahl handelt.
     * Achtung, diese Lösung ist nicht besonders effizient
